$d = $PSScriptRoot
$log = Join-Path $d 'images-lot5-now.log'
...
"$(Get-Date -Format HH:mm:ss) ComfyUI pret" | Add-Content $log
& powershell -NoProfile -ExecutionPolicy Bypass -File "$d\images-lot.ps1" 'tools/gen3d/images-lot5.json'
